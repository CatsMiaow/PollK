...
define(['directives/_directives'], function(directives) {
    directives.controller('PaginationController', ['$scope', '$attrs', '$parse',
    ...
    directives.constant('paginationConfig', {
        itemsPerPage  : 10,
        boundaryLinks : false,
        directionLinks: true,
        firstText     : 'First',
    ...
    directives.constant('pagerConfig', {
        itemsPerPage: 10,
        previousText: '« Previous',
        nextText    : 'Next »',
        align       : true
        ...
        function(pagerConfig) {
            return {
                ...
                controller: 'PaginationController',
                templateUrl: 'views/directive/pager',
                replace: true,
                link: function(scope, element, attrs, ctrls) {
                    var paginationCtrl = ctrls[0], ngModelCtrl = ctrls[1];
